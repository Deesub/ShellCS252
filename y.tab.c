...
static const yytype_int8 yyrhs[] =
{
      ...
      17,    -1,    18,    24,    22,    25,     6,    -1,     6,    -1,
       1,     6,    -1,    21,    19,    -1,    19,    20,    -1,    -1,
       3,    -1,     3,    -1,    22,    23,    -1,    -1,     5,     3,
      -1,     7,     3,    -1,     9,     3,    -1,    10,     3,    -1,
      11,     3,    -1,    24,    12,    18,    -1,    18,    -1,    -1,
       8,    -1,    -1
};
...
{
       0,    48,    48,    52,    53,    56,    60,    64,    67,    73,
      80,    81,    85,    98,   108,   109,   113,   125,   137,   152,
     167,   184,   185,   186,   190,   193
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREATGREAT", "AMPERSAND", "GREATAMPERSAND", "GREATGREATAMPERSAND",
  "LESS", "PIPE", "$accept", "goal", "commands", "command",
  "simple_command", "command_and_args", "arg_list", "argument",
  "command_word", "iomodifier_list", "iomodifier_opt", "pipe_list",
...
static const yytype_uint8 yydefact[] =
{
       ...
       8,     1,     4,    22,    15,     9,     0,    25,    12,    10,
      21,     0,     0,    24,     0,     0,     0,    14,     0,    16,
      17,    18,    19,    20,     6
};
...
{
      10,     8,    -9,    -9,     2,     9,    -9,    -9,    14,    -9,
      -9,    -9,    -9,    -9,     6,    16,    14,    -4,    -9,    -9,
      -9,    17,    18,    -9,    19,    20,    21,    -9,    22,    -9,
      -9,    -9,    -9,    -9,    -9
};
...
{
      13,    21,    11,    22,    23,    24,    25,    26,    20,    -2,
       1,     1,     2,     2,    10,     3,     3,     2,    16,    18,
      29,    30,    31,    32,    33,     0,     0,     0,    34,    12
};

static const yytype_int8 yycheck[] =
{
       8,     5,     0,     7,     8,     9,    10,    11,    16,     0,
       1,     1,     3,     3,     6,     6,     6,     3,    12,     3,
       3,     3,     3,     3,     3,    -1,    -1,    -1,     6,     5
};
...
static const yytype_uint8 yystos[] =
{
       ...
       6,     0,    16,    18,    24,    19,    12,    22,     3,    20,
      18,     5,     7,     8,     9,    10,    11,    23,    25,     3,
       3,     3,     3,     3,     6
};
...
#line 85 "shell.y"
    {
		...
		if((strchr((yyvsp[(1) - (1)].string_val),'*') == NULL) && (strchr((yyvsp[(1) - (1)].string_val),'?') == NULL)){
			Command::_currentSimpleCommand->insertArgument((yyvsp[(1) - (1)].string_val));
	 	      	...
	 	      	expandWildcards(NULL,(yyvsp[(1) - (1)].string_val));
		}
	}
    break;
